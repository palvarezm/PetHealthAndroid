...
public class SearchAdapters extends RecyclerView.Adapter<SearchAdapters.ViewHolder> {
    ...
    private List<VeterinaryModel.Veterinary> veterinaries;

    public SearchAdapters() {
    }

    public SearchAdapters(List<VeterinaryModel.Veterinary> veterinaries) {
        this.veterinaries = veterinaries;
    }

    public List<VeterinaryModel.Veterinary> getVeterinaries() {
        return veterinaries;
    }

    public SearchAdapters setVeterinaries(List<VeterinaryModel.Veterinary> veterinaries) {
        this.veterinaries = veterinaries;
        return this;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final VeterinaryModel.Veterinary veterinary = veterinaries.get(position);
